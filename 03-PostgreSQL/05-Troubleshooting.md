...
```
SELECT 'migration.rtable' AS Rtable, SUM(pg_total_relation_size('migration.rtable')) AS size, COUNT(pg_total_relation_size('migration.rtable')) AS Count FROM information_schema.tables;
```
